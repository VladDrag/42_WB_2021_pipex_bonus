...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/12/14 14:56:44 by vdragomi          #+#    #+#             */
/*   Updated: 2021/12/14 14:56:44 by vdragomi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv, char **envp)
{
	...
	input_file_checker(argv[1], argv[argc - 1]);
	output_file_checker(argv[argc - 1]);
	ft_build_cmd_list(argv, envp, argc, &cmd_list);
...
void	ft_build_cmd_list(char **argv, char **envp, int argc, t_list **cmd_list)
{
	t_content	*content;
	t_list		*elem;
	char		**path_list;
